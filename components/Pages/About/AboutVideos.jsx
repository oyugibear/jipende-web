  ...
  return (
    <div className='flex flex-col w-full my-6 text-center'>
        ...
        <div className='flex flex-wrap items-start justify-evenly gap-4'>
            ...
            <iframe className='w-full md:w-1/4 h-full aspect-video' src='https://www.youtube.com/embed/LOAQ-_uWTCI' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture' allowFullScreen/>
            <iframe className='w-full md:w-1/4 h-full aspect-video' src='https://www.youtube.com/embed/4P1pVn_taF4' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture' allowFullScreen/>
        </div>
    </div>
  )
}
