  ...
  return (
    <div className='flex flex-col w-full my-6 text-center'>
        ...
        <div className='flex flex-wrap items-start justify-evenly gap-4'>
            ...
            <iframe className='w-full md:w-1/4 h-full aspect-video shadow-xl rounded-lg' src='https://www.youtube.com/embed/vPkbDzN9ddU' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture' allowFullScreen/>
        </div>
    </div>
  )
}
