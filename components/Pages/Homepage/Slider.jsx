...
export default function Slider() {
  return (
    <div className='w-full h-full relative'>
        ...
        <Image src='/assets/homepage/homebg.jpg' alt='happy person' width={1920} height={568} className='h-[800px] max-h-[568px] xl:max-h-[1000px] w-full object-cover object-top'/>
    </div>
  )
}
